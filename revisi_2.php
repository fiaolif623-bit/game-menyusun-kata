...
<html lang="id">
  ...
  <script>
    ...
    const levels = {
      1: {
        name: "Mudah",
        questions: [
          { word: "IKAN", category: "hewan", emoji: "🐟", hint: "Hidup di air", question: "Hewan yang hidup di air dan bernapas dengan insang?" },
          { word: "APEL", category: "buah", emoji: "🍎", hint: "Buah berwarna merah", question: "Buah yang sering berwarna merah atau hijau, sering dimakan untuk kesehatan?" },
          { word: "BALI", category: "kota", emoji: "🏝️", hint: "Pulau wisata", question: "Pulau wisata terkenal di Indonesia dengan pantai indah?" },
          { word: "KUDA", category: "hewan", emoji: "🐴", hint: "Hewan berkaki empat", question: "Hewan berkaki empat yang bisa ditunggangi?" },
          { word: "NANAS", category: "buah", emoji: "🍍", hint: "Buah berduri", question: "Buah tropis yang memiliki kulit berduri dan daging berwarna kuning?" }
        ]
      },
      2: {
        name: "Sedang",
        questions: [
          { word: "KUCING", category: "hewan", emoji: "🐱", hint: "Hewan peliharaan yang suka ikan", question: "Hewan peliharaan yang suka mengeong dan berburu tikus?" },
          { word: "JERUK", category: "buah", emoji: "🍊", hint: "Buah kaya vitamin C", question: "Buah bulat berwarna oranye yang kaya akan vitamin C?" },
          { word: "MEDAN", category: "kota", emoji: "🌃", hint: "Kota di Sumatera Utara", question: "Kota terbesar di Sumatera Utara yang terkenal dengan kuliner?" },
          { word: "BURUNG", category: "hewan", emoji: "🐦", hint: "Hewan yang bisa terbang", question: "Hewan yang memiliki sayap dan bisa terbang di udara?" },
          { word: "PISANG", category: "buah", emoji: "🍌", hint: "Buah favorit monyet", question: "Buah panjang berwarna kuning yang menjadi makanan favorit monyet?" }
        ]
      },
      3: {
        name: "Sulit",
        questions: [
          { word: "KELINCI", category: "hewan", emoji: "🐰", hint: "Hewan dengan telinga panjang", question: "Hewan berbulu lembut dengan telinga panjang yang suka makan wortel?" },
          { word: "SEMANGKA", category: "buah", emoji: "🍉", hint: "Buah besar berair", question: "Buah besar berair dengan daging merah dan biji hitam?" },
          { word: "BANDUNG", category: "kota", emoji: "🌆", hint: "Kota kembang", question: "Kota di Jawa Barat yang dijuluki sebagai Kota Kembang?" },
          { word: "DURIAN", category: "buah", emoji: "🌰", hint: "Raja buah yang berbau", question: "Buah berduri dengan aroma kuat yang dijuluki Raja Buah?" },
          { word: "SURABAYA", category: "kota", emoji: "🏢", hint: "Kota pahlawan", question: "Kota terbesar kedua di Indonesia yang dijuluki Kota Pahlawan?" }
        ]
      },
      4: {
        name: "Sangat Sulit",
        questions: [
          { word: "YOGYAKARTA", category: "kota", emoji: "🕌", hint: "Kota pelajar dan budaya", question: "Daerah Istimewa yang terkenal dengan Candi Borobudur dan Keraton?" },
          { word: "SEMARANG", category: "kota", emoji: "🌇", hint: "Kota Lumpia", question: "Ibu kota Jawa Tengah yang terkenal dengan kuliner lumpia?" },
          { word: "JAKARTA", category: "kota", emoji: "🏙️", hint: "Ibu kota Indonesia", question: "Ibu kota negara Indonesia yang merupakan pusat pemerintahan?" }
        ]
      }
    };
 ...
 <script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'99fe167565fe49c8',t:'MTc2MzM3MDU1MC4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>